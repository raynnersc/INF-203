...
function showTxt() {
    ...
    xhr.open("GET", `${local}/Slices`, true);
    xhr.onload = function () {
        if (xhr.status === 200) {
            document.getElementById("MAINSHOW").textContent = xhr.responseText;
        }
    };
    xhr.send();
}
...
function showAddForm() {
    document.getElementById("textTF").style.visibility = "visible";
    document.getElementById("colorTF").style.visibility = "visible";
    document.getElementById("valueTF").style.visibility = "visible";
    document.getElementById("VALIDADD").style.visibility = "visible";
}
...
function restoreJSON() {
    var xhr = new XMLHttpRequest();
    xhr.open("GET", `${local}/restore`, true);
    xhr.onload = function () {
        if (xhr.status === 200) {
            document.getElementById("MAINSHOW").textContent = "";
        }
...
function remove() {
    var xhr = new XMLHttpRequest();
    xhr.open("GET", `${local}/remove?index=${document.getElementById("indexTF").value}`, true);
    xhr.onload = function () {
        if (xhr.status === 200) {
            document.getElementById("MAINSHOW").textContent = "";
        }
...
function add() {
    var xhr = new XMLHttpRequest();
    xhr.open("GET", `${local}/add?title=${document.getElementById("titleTF").value}&value=${document.getElementById("valueTF").value}&color=${document.getElementById("colorTF").value}`, true);
    xhr.onload = function () {
        if (xhr.status === 200) {
            document.getElementById("MAINSHOW").textContent = "";
        }
...
function showPieChart() {
    var xhr = new XMLHttpRequest();
    xhr.open("GET", `${local}/PChart`, true);
    xhr.onload = function () {
        if (xhr.status === 200) {
            document.getElementById("MAINSHOW").innerHTML = xhr.responseText;
        }
    };
    xhr.send();
}
...
function showLocalPieChart() {
    ...
    xhr.onload = function () {
        if (xhr.status === 200) {
            ...
            svgContent += `</svg>`;
            document.getElementById("MAINSHOW").innerHTML = svgContent;
        }
    };
    xhr.send();
}
